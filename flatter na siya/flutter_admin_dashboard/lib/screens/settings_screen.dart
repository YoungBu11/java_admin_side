...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _buildRightPanel() {
    if (selectedSetting == 'Emergency Hotlines') {
      ...
      // ...existing code for System Backup...
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text(
    ...
    } else if (selectedSetting == 'Admin Permissions') {
      // ...existing code for Admin Permissions...
      final List<Map<String, dynamic>> adminPermissions = [
        {
          'name': 'Manage Users',
      ...
      return Column(
        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
              itemCount: adminPermissions.length,
              separatorBuilder: (context, index) => const SizedBox(height: 8),
              itemBuilder: (context, index) {
                final perm = adminPermissions[index];
                return Card(
                  child: ListTile(
                    leading: Icon(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _SettingsCard(
                          ...
                          onConfigure: () {
                            setState(() {
                              selectedSetting = 'Admin Permissions';
                            });
                          },
                        ),
                        const SizedBox(height: 16),
